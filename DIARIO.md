...
> Cómo se llegó a cada sitio: los inventarios, los spikes, lo que se probó y no
> valía, y lo que se rompió por el camino. **No es normativo**: lo que está
> decidido vive en `PLAN.md`, y si los dos dicen cosas distintas manda `PLAN.md`.
>
> Está en el orden en que pasó y se lee a trozos, buscando una fecha o un nombre.
...
## Lo que se fue cerrando de la lista (2026-08-08/09)

> Estaba dentro de «Lo siguiente, por orden», tachado. Es diario.
